...
# Copyright (c) 2024 TurtleBot3 + Hector SLAM + Nav2 Integration
...
def generate_launch_description():
    ...
    robot_state_publisher_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(turtlebot3_bringup_dir, 'launch', 'robot_state_publisher.launch.py')
        ),
        launch_arguments={
    ...
    # TurtleBot3 bringup (sensors, drivers)
    turtlebot3_bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(turtlebot3_bringup_dir, 'launch', 'turtlebot3_bringup.launch.py')
        ),
        launch_arguments={
            'use_sim_time': use_sim_time,
        }.items()
    ...
    ld.add_action(turtlebot3_bringup_cmd)
